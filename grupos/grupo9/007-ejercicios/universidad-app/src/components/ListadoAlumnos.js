...
export default class ListadoAlumnos extends React.Component {
  constructor(props) {
    super(props);
    
    this.state = {  
      coleccion: "alumnos",
      todos: this.props.data.alumnos,
            ...
            this.props.data.map((e) => {
              ...
              return (
                <AlumnoItem
                  Key={e.id}
                  value={e}
                  onMostrarDetalleAlumno={ this.props.onMostrarDetalleAlumno}
                  onEliminarAlumno={this.props.onEliminarAlumno}
