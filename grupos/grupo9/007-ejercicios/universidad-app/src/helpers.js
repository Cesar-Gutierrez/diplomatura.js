...
export const helpers=
{
    ...
    findAlumnoByID : (id)=> {
      console.log('busco el alumno con id',id);
      console.log('retorno el elemento ',(helpers.findById("alumnos")(id)));
      return (helpers.findById("alumnos")(id));},
...
// export function   getColeccion (collection) {
//         // abrimos la conexión        
//         return database[collection];
//       }
